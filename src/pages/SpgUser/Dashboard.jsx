...
import { Eye, EyeOff, Clock, Download, UserPlus, UserMinus, Briefcase, ShieldCheck, Database, UploadCloud, Receipt, CalendarX, Send, FileText, AlertTriangle, Users } from 'lucide-react';
...
function Dashboard() {
    ...
    const fetchWorkflowStats = async () => {
        try {
            ...
            // Silently failing to prevent console spam for non-critical stats
        }
    };
    ...
    useEffect(() => {
        ...
        // Auto-refresh every 15 seconds for real-time updates (lowered from 2s to prevent server overloads)
        ...
        <div>
            ...
            <div className="circle-cards-section">
                ...
                <div
                    className="circle-card"
                    style={{ padding: '0.25rem', justifyContent: 'flex-start', cursor: 'pointer' }}
                    onClick={() => navigate('/app/MyActivity', { state: { activeTab: 'employee' } })}
                >
                    <div className="circle-card-title" style={{ marginBottom: '0.25rem', fontSize: '0.7rem' }}>Employee Data Summary</div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0', width: '100%', fontSize: '0.65rem', padding: '0 0.1rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ color: 'var(--text-secondary)' }}>Total Customers</span>
                            <span style={{ fontWeight: 'bold', color: 'var(--text-primary)' }}>175</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ color: 'var(--text-secondary)' }}>Total Employees</span>
                            <span style={{ fontWeight: 'bold', color: 'var(--info-color)' }}>35</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ color: 'var(--text-secondary)' }}>UAN Missing</span>
                            <span style={{ fontWeight: 'bold', color: 'var(--danger-color)' }}>51</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ color: 'var(--text-secondary)' }}>Birthdate Missing</span>
                            <span style={{ fontWeight: 'bold', color: 'var(--warning-color)' }}>45</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ color: 'var(--text-secondary)' }}>Join Date Missing</span>
                            <span style={{ fontWeight: 'bold', color: 'var(--danger-color)' }}>10</span>
                        </div>
                    </div>
                </div>
